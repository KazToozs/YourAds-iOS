...
class CameraView: UIImageView, AVCaptureVideoDataOutputSampleBufferDelegate
{
    ...
    func handleCamera()
    {
        ...
        if(session?.canAddOutput(output) == true){
            ...
            output?.connection(withMediaType: AVMediaTypeVideo).isEnabled = true
                           ...
                           from connection: AVCaptureConnection!)
        {
            ...
            let imageOptions : NSDictionary = [CIDetectorImageOrientation : NSNumber(value: exifOrientation)]
...
//            })
            ...
            DispatchQueue.main.async {
                self.drawFaceBoxesForFeatures(features: features as NSArray, clap: clap, orientation: UIDevice.current.orientation)
            }
